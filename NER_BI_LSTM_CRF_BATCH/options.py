...
class options():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--DataPath', type=str, nargs='?', default='/home/youngwook/Downloads/entity-recognition-datasets-master/data/wikigold/CONLL-format/data/wikigold.conll.txt', help='path to the datasets')
        self.parser.add_argument('--TagPath', type=str, nargs='?', default='data/tags-universal.txt', help='path to the tagset')

        self.parser.add_argument('--use_features', type=bool, nargs='?', default=True, help='Whether to use features other than just words')
        self.parser.add_argument('--feature_size', type=int, nargs='?', default=3, help='number of features that will be used')
        ...
        self.parser.add_argument('--num_layers', type=int, nargs='?', default=2, help='number of recurrent layers')
