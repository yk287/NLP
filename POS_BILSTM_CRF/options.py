...
class options():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--const_epoch', type=int, nargs='?', default=1, help='number of epochs where LR is constant')
        ...
        #LSTM Options
        self.parser.add_argument('--batch_size', type=int, nargs='?', default=1, help='batch size to be used')
