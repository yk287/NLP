...
class options():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--num_classes', type=int, nargs='?', default=18, help='number of classes')

        #Data loader options
        self.parser.add_argument('--path', type=str, nargs='?', default='data/names/*.txt', help='path to the datasets')
        ...
        self.parser.add_argument('--hidden_size', type=int, nargs='?', default=128, help='number of features in hidden state')
        ...
        self.parser.add_argument('--embedding_dim', type=int, nargs='?', default=128, help='dimension of word embedding')
