...
class options():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--topk', type=int, nargs='?', default=10, help='Removes top k most commonly occuring words from dict')
        self.parser.add_argument('--remove_topk', type=bool, nargs='?', default=True, help='Whether remove words')

        #LSTM Options
        self.parser.add_argument('--batch_size', type=int, nargs='?', default=8, help='batch size to be used')
